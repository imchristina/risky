...
// Bus module to control the flow of data without using tristate logic to help make this synth on real hardware
// Single common output, many inputs with input enables lines for each module
module risky_bus (input clk, input [`RISKY_BUS_INPUTS*32:0] bus_inputs, output bus_out);
